 ...
 * Time: 上午10:42
 */
class plugin_walkskyer_watermark{
    protected $vars;
    protected $forumid;
    protected $groupid;
    ...
    public function __construct() {
        global $_G;
        $this->vars = $_G['cache']['plugin']['walkskyer_watermark'];
    ...
    function common(){
        global $_G;
        if(!$this->vars['wk_watermark_on']) return;
        require_once DISCUZ_ROOT.'./source/plugin/walkskyer_watermark/source/function/function_wk.php';
        ...
        if($_GET['operation'] == 'upload' && $this->vars['wk_forum']) {
            ...
            require_once DISCUZ_ROOT.'./source/plugin/walkskyer_watermark/wk_forum_upload.class.php';
            wk_forum_upload();
        }elseif($_GET['operation'] == 'portal' && $this->vars['wk_portal']) {
            require_once DISCUZ_ROOT.'./source/plugin/walkskyer_watermark/wk_portal_upload.class.php';
            wk_portal_upload();
        }elseif($_GET['operation'] == 'album' && $this->vars['wk_album']) {
            require_once DISCUZ_ROOT.'./source/plugin/walkskyer_watermark/wk_album_upload.class.php';
            wk_album_upload();
        }
    }
}